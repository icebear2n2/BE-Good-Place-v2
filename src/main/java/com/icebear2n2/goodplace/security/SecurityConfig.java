package com.icebear2n2.goodplace.security;

import com.icebear2n2.goodplace.domain.repository.UserRepository;
import com.icebear2n2.goodplace.security.jwt.JwtAuthorizationFilter;
import com.icebear2n2.goodplace.security.oauth2.OAuth2UserService;
...
//                                .hasAnyRole("ADMIN")
                ...
                .oauth2Login(oauth ->
                        oauth.userInfoEndpoint((u) -> u.userService(new OAuth2UserService(userRepository)))
                                ...
                                .defaultSuccessUrl("/token/oauth", true)
                )
